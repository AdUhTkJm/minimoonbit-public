...
let main = async function () {
    ...
    let importObject = {
        ...
        minimbt_print_int: (value) => {
            /*
            let view = new Int32Array(memory.buffer, 0, 12);
            for (let x of view) {
    ...
    let _instance = await WebAssembly.instantiate(wasm_code, {
        moonbit: importObject,
    });
};
